...
\begin{rSection}{Experience}
    \begin{rSubsection}{SeekOut}{March 2021 - Present}{Senior Software Engineer 2, Seattle, WA}
        ...
        \item Led technical architecture, code reviews, and product development for new recruiter automation product, engaging directly with customers and recruiters to gather requirements while mentoring junior engineers and building scalable systems including LLM-based candidate evaluation and ATS integration
        \item Served as Forward Deployed Engineer, integrating with multiple client ATS systems across diverse platforms, implementing deep automations for prospect creation, candidate management, and job stage transitions
        \item Established company-wide AI infrastructure enabling engineering organization to leverage coding agents for code generation, documentation, unit testing, and internal tooling aligned with SeekOut standards
...
\begin{rSubsection}{Counterpart}{May 2020 - March 2021}{Software Engineer, Fishers, IN}
    ...
    \item Developed new features and maintained a custom internal task management software for Keramida, and a custom software selling environmental reports, for ISRI using .Net MVC
    \end{rSubsection}
...
\item Created autonomous Batch Files and Excel VBA scripts to aid Lab Technicians in their duties
\end{rSubsection}
...
Tools & Azure, Docker, Git, Databricks, Claude Code, Gemini\\[0.001ex]
